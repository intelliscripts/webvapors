...
class Time {
    ...
    renderViewContainer(component) {
        return (core.h("div", { class: 'time-view-container' },
    ...
    renderPickerFooter(component) {
        return (core.h("div", { class: 'picker-footer' },
            core.h("button", { class: 'sm-button', onClick: () => {
                    component.showPicker = false;
                } }, "Close"),
            core.h("button", { class: 'sm-button primary ok-button', onClick: () => {
    ...
    renderPickerHeader(_component) {
        return (core.h("div", { class: 'picker-header' }));
    }
    isMaxHour(component) {
    ...
    renderPickerBody(component) {
        return (core.h("div", { class: 'picker-body' },
            core.h("div", { class: 'row' },
                core.h("div", { class: 'column' },
                    core.h("div", { class: 'up-triangle', onClick: () => {
...
class Hour {
    ...
    renderViewContainer(component) {
        return (core.h("div", { class: 'hour-view-container' },
            this.renderPickerHeader(component),
            this.renderPickerBody(component)));
    }
    renderPickerHeader(_component) {
    ...
    renderPickerBody(component) {
        return (core.h("div", { class: 'picker-body' }, this.renderHours(component)));
    }
    ...
    getRow(component, hours) {
        ...
        hours.forEach((hour) => {
            ...
            cells.push(core.h("div", { class: cls.join(' '), onClick: () => {
                ...
                core.h("div", { class: 'hour-number' }, getDisplayValue(hour))));
        });
        return (core.h("div", { class: "hour-row" }, cells));
    }
    getHours(component) {
        const hours = [];
        let maxHours = 23;
...
class Minute {
    ...
    renderViewContainer(component) {
        return (core.h("div", { class: 'minute-view-container' },
            this.renderPickerHeader(component),
            this.renderPickerBody(component)));
    }
    renderPickerHeader(_component) {
    ...
    renderPickerBody(component) {
        return (core.h("div", { class: 'picker-body' }, this.renderMinutes(component)));
    }
    ...
    getRow(component, minutes) {
        ...
        minutes.forEach((minute) => {
            ...
            cells.push(core.h("div", { class: cls.join(' '), onClick: () => {
                ...
                core.h("div", { class: 'minute-number' }, getDisplayValue(minute))));
        });
        return (core.h("div", { class: "minute-row" }, cells));
    }
...
class TimePicker {
    ...
    renderDropdown(component) {
        return (core.h("div", { class: 'sm-time-picker-dropdown', onClick: () => this.togglePicker(component) },
            core.h("span", null, component.label || this.getTime(component)),
            core.h("div", { class: "down-triangle" })));
    }
    renderPicker(component) {
        ...
        return (core.h("div", { class: 'sm-time-picker-popover' },
            core.h("div", { class: 'sm-time-picker-popover-container' }, currentView)));
    }
    render(component) {
...
const SmTimePicker = class {
    constructor(hostRef) {
        ...
        this.timeSelected = core.createEvent(this, "timeSelected", 7);
    }
    ...
    render() {
        return (core.h(core.Host, { style: { '--theme-color': this.theme } }, core.h("div", { class: 'sm-time-picker' }, core.h("div", { class: 'sm-time-picker-container' }, timePicker.render(this)))));
    }
...
exports.sm_time_picker = SmTimePicker;
