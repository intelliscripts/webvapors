...
const index = require('./index-d8b1bc81.js');
...
const INTERNAL_DATE_TIME_REGEX = /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}$/;

class Header {
    render(component) {
        return (core.h("div", { class: 'header-container' },
            core.h("div", { class: 'header-section' }, this.renderViewNavigation(component)),
            core.h("div", { class: 'header-section' },
                core.h("div", { class: 'context-date-label' }, component.viewRenderer.getHeaderText(component))),
            core.h("div", { class: 'header-section' }, this.renderViewButton(component))));
    }
    renderViewRange(component) {
        return (core.h("div", { class: 'view-range' }, component.viewRenderer.getHeaderText(component)));
    }
    renderViewNavigation(component) {
        return (core.h("div", { class: 'view-navigation' },
            core.h("div", { class: 'nav-item' },
                core.h("div", { class: 'btn-list' },
                    core.h("div", { class: 'btn-list-item' },
                        core.h("div", { class: "left-triangle", onClick: () => {
                                component.viewRenderer.prev(component);
                            } })),
                    core.h("div", { class: 'btn-list-item' },
                        core.h("div", { class: 'today-button', onClick: () => {
                                component.contextDate = index.moment().startOf('day').format(INTERNAL_FORMAT.DATE);
                            } }, "Today")),
                    core.h("div", { class: 'btn-list-item' },
                        core.h("div", { class: "right-triangle", onClick: () => {
                                component.viewRenderer.next(component);
                            } })))),
            core.h("div", { class: 'nav-item' },
                core.h("div", { class: 'date-picker' },
                    core.h("sm-date-picker", { onDateSelected: (payload) => {
    ...
    renderViewButton(component) {
        ...
        availableViews.forEach((view) => {
            ...
            buttons.push(core.h("div", { class: cls.join(' '), onClick: () => {
                    component.view = view;
                } }, VIEW_LABELS[view]));
        });
        return (core.h("div", { class: 'view-list' }, buttons));
    }
}
...
class TemplateRenderer {
    eventContainer(event) {
        return (core.h("div", { class: "event-container" },
            core.h("div", { class: "event-title" }, event.title)));
    }
}
...
class View {
    ...
    render(component) {
        ...
        return (core.h("div", { class: cls.join(' ') }, this.renderView(component)));
    }
...
function getTimeFromStartOfDay(dateTime, units = 'seconds') {
    return dateTime.diff(index.moment$1(dateTime).startOf('day'), units);
}
function getTimeDiff(date1, date2, units = 'seconds') {
...
class ColumnTemplateRenderer extends TemplateRenderer {
    constructor() {
        super();
    }
    eventContainer(event) {
        ...
        return (core.h("div", { class: "event-container" },
            core.h("div", { class: "event-title" },
                ...
                core.h("br", null),
                event.title),
            core.h("div", { class: "event-description" }, event.description)));
    }
}
const templateRenderer$1 = new ColumnTemplateRenderer();
...
class Column extends View {
    constructor() {
        ...
        this.templateRenderer = templateRenderer$1;
    }
    next(component) {
    ...
    renderView(component) {
        ...
        return (core.h("div", { class: cls.join(' '), style: { '--left-scale-width': this.leftScaleWidth + 'px', '--time-step-height': this.timeStepHeight + 'px', '--view-header-height': this.viewHeaderHeight + 'px' } },
            this.renderViewHeader(component),
            this.renderViewBody(component)));
    }
    renderViewBody(component) {
        const cls = ['view-body'];
        return (core.h("div", { class: cls.join(' ') },
            core.h("div", { class: 'view-body-relative' },
                this.renderLeftScale(component),
                this.renderDrawingArea(component))));
    }
    renderDrawingArea(component) {
        return (core.h("div", { class: 'drawing-area-container' },
            core.h("div", { class: 'drawing-area-container-relative' },
    ...
    renderEvents(component) {
        ...
        return (core.h("div", { class: 'events-wrapper' }, events));
    }
    getEvents(component) {
        const events = [];
        ...
        for (let column in eventsColumnMap) {
            ...
            const overlaps = getOverlaps(columnEvents, null);
    ...
    getEvent(component, event) {
        ...
        return (core.h("div", { class: 'event', style: Object.assign({}, eventStyles), onClick: () => {
    ...
    renderGrid(component) {
        return (core.h("div", { class: 'grid-wrapper' }, this.renderGridRows(component)));
    }
    renderGridRows(component) {
        ...
        stepMoments.forEach((_stepMoment, index) => {
            ...
            gridDates.forEach((viewDate) => {
                cols.push(core.h("div", { class: 'item', style: { height: this.timeStepHeight + 'px' }, onClick: () => {
            ...
            rows.push(core.h("div", { class: 'row' }, cols));
        });
        return rows;
    }
    getSteps() {
        const totalSteps = (24 * 60) / this.timeStepDuration;
        const today = index.moment$1().startOf('day');
        const stepMoments = [];
    ...
    renderLeftScale(component) {
        ...
        stepMoments.forEach((stepMoment, index) => {
            steps.push(core.h("div", { class: 'step', style: { height: this.timeStepHeight + 1 + 'px' } },
                core.h("div", { class: 'step-time' }, index === 0 ? '' : stepMoment.format(this.timeStepFormat))));
        });
        return (core.h("div", { class: 'left-scale' },
            core.h("div", { class: 'step-container' }, steps)));
    }
    renderViewHeader(component) {
        ...
        gridHeaderDates.forEach((date) => {
            const cls = ['item'];
            if (date.isSame(index.moment$1(), 'day')) {
                cls.push('today');
            }
            if (date.isSame(contextMoment, 'day')) {
                cls.push('context-date');
            }
            dayNames.push(core.h("div", { class: cls.join(' ') },
                core.h("div", { class: 'view-header-column' },
                    core.h("div", { class: 'day-date', onClick: () => {
                            component.contextDate = date.format(INTERNAL_FORMAT.DATE);
                            component.view = VIEWS.day;
                        } }, date.format('DD')),
                    core.h("div", { class: 'day-name' }, date.format('dddd')))));
        });
        return (core.h("div", { class: cls.join(' ') },
            core.h("div", { class: 'row' },
                core.h("div", { class: 'empty-left-scale' }),
                dayNames)));
    }
}
new Column();

class DayTemplateRenderer extends ColumnTemplateRenderer {
    constructor() {
        super();
    }
}
const templateRenderer$2 = new DayTemplateRenderer();

class Day extends Column {
    constructor() {
        super();
        this.numberOfCols = 1;
        this.templateRenderer = templateRenderer$2;
    }
    calculateViewRange(contextMoment, _weekStartDay) {
    ...
    getHeaderText(component) {
        return (core.h("div", null, component.contextMoment.format('DD MMMM YYYY')));
    }
    getDatePickerLabel(component) {
        return component.contextMoment.format('DD MMM YYYY');
    }
}
const dayView = new Day();

class WeekTemplateRenderer extends ColumnTemplateRenderer {
    constructor() {
        super();
    }
}
const templateRenderer$3 = new WeekTemplateRenderer();

class Week extends Column {
    constructor() {
        super();
        this.numberOfCols = 7;
        this.templateRenderer = templateRenderer$3;
    }
    calculateViewRange(contextMoment, weekStartDay) {
        ...
        const endMoment = index.moment$1(startMoment).add(this.numberOfCols - 1, 'days').endOf('day');
        return { startMoment, endMoment };
    }
}
const weekView = new Week();
...
class MonthTemplateRenderer extends TemplateRenderer {
    constructor() {
        super();
    }
    eventContainer(event) {
...
const templateRenderer$4 = new MonthTemplateRenderer();
...
var simpleSwizzle = index.createCommonjsModule(function (module) {
...
var colorString = index.createCommonjsModule(function (module) {
/* MIT license */
...
var conversions = index.createCommonjsModule(function (module) {
/* MIT license */
...
class Month extends View {
    constructor() {
        ...
        this.templateRenderer = templateRenderer$4;
    }
    next(component) {
    ...
    renderView(component) {
        ...
        const cls = ['view-wrapper'];
        return (core.h("div", { class: cls.join(' '), style: { '--view-header-height': this.viewHeaderHeight + 'px' } },
            this.renderViewHeader(component),
            this.renderViewBody(component)));
    }
    renderViewBody(component) {
        const cls = ['view-body'];
        return (core.h("div", { class: cls.join(' ') },
            core.h("div", { class: 'view-body-relative' }, this.renderDrawingArea(component))));
    }
    renderDrawingArea(component) {
        return (core.h("div", { class: 'drawing-area-container' },
            core.h("div", { class: 'drawing-area-container-relative' },
    ...
    getRow(component, rowDates, _rowcount, rowIndex) {
        ...
        return (core.h("div", { class: 'row', style: { 'height': rowHeight } }, cols));
    }
    getCellWrapper(component, date, rowHeight) {
        ...
        return (core.h("div", { class: cls.join(' '), style: cellStyles },
            core.h("div", { class: 'cell-wrapper', style: { height: rowHeight }, onClick: () => {
                    component.cellClick.emit({
                        view: component.view,
                ...
                core.h("div", { class: 'cell-header', style: { height: this.gridCellHeaderHeight + 'px' } },
                    core.h("div", { class: 'cell-date', onClick: (ev) => {
                            component.contextDate = date.format(INTERNAL_FORMAT.DATE);
                            component.view = VIEWS.day;
                            ev.stopPropagation();
                            ev.preventDefault();
    ...
    renderViewHeader(component) {
        ...
        gridHeaderDates.forEach((date) => {
            ...
            dayNames.push(core.h("div", { class: 'item' },
                core.h("div", { class: headerColumnCls.join(' ') },
                    core.h("div", { class: 'day-name' }, date.format('dddd')))));
        });
        return (core.h("div", { class: cls.join(' ') },
            core.h("div", { class: 'row' }, dayNames)));
    }
    calculateViewRange(contextMoment, weekStartDay) {
        return calculateDateRange(contextMoment, weekStartDay);
    }
    getHeaderText(component) {
        return (core.h("div", null, component.contextMoment.format('MMMM YYYY')));
    }
    getDatePickerLabel(component) {
...
const monthView = new Month();

class ContextPanelTemplateRenderer {
}
const templateRenderer$5 = new ContextPanelTemplateRenderer();
...
class ContextPanel {
    ...
    renderContextPanel(component) {
        return (core.h("div", { class: 'context-panel-container' },
            core.h("div", { class: 'context-panel-wrapper' },
                this.renderHeader(component),
                this.renderBody(component))));
    }
    renderHeader(component) {
        return (core.h("div", { class: 'context-panel-header' },
            core.h("div", { class: 'context-date' }, component.contextMoment.format('DD MMM, YYYY'))));
    }
    renderBody(component) {
        return (core.h("div", { class: 'context-panel-body' }, this.renderContextDateEvents(component)));
    }
    renderContextDateEvents(component) {
        ...
        if (events.length > 0) {
            events.forEach((event) => {
                eventsDOM.push(core.h("div", { class: 'context-panel-event', style: { 'border-left-color': event.borderColor }, onClick: () => {
                        component.eventClick.emit({
                            event: event.rawEvent,
                            isContextPanel: true
                        });
                    } },
                    core.h("div", { class: 'context-panel-event-header' },
                        core.h("div", { class: 'event-time' },
                            event.startMoment.format(INTERNAL_FORMAT.DISPLAY_TIME),
                            " - ",
                            event.endMoment.format(INTERNAL_FORMAT.DISPLAY_TIME))),
                    core.h("div", { class: 'context-panel-event-body' },
                        core.h("div", { class: 'event-title' }, event.title),
                        core.h("div", { class: 'event-description' }, event.description))));
            });
            return eventsDOM;
        }
        return (core.h("div", { class: 'no-events' }, "No Events"));
    }
...
class EditEvent {
    ...
    renderEditEventModal(component) {
        return (core.h("div", { class: 'event-edit-container' },
            core.h("div", { class: 'event-edit-wrapper', style: { 'border-top-color': component.selectedEvent.borderColor } },
                this.renderHeader(component),
                this.renderBody(component),
                this.renderFooter(component))));
    }
    renderFooter(component) {
        return (core.h("div", { class: 'event-edit-footer' },
            core.h("button", { class: 'sm-button', onClick: () => {
                    component.selectedEvent = null;
                } }, "Cancel"),
            core.h("button", { class: 'sm-button primary flat ok-button', onClick: () => {
    ...
    renderHeader(component) {
        return (core.h("div", { class: 'event-edit-header' },
            component.selectedEvent.title,
            core.h("div", { class: 'close', onClick: () => {
                    component.selectedEvent = null;
                } }, "X")));
    }
    renderBody(component) {
        return (core.h("div", { class: 'event-edit-body' },
            core.h("div", { class: 'form-row' },
                core.h("label", { class: 'form-label' }, "Start time"),
                core.h("div", { class: 'form-element date-time-picker' },
                    core.h("div", { class: 'date-picker' },
                        core.h("sm-date-picker", { onDateSelected: (payload) => {
                                component.selectedEvent.originalStartMoment = index.moment$1(payload.detail + ' ' + component.selectedEvent.originalStartMoment.format(INTERNAL_FORMAT.TIME));
                    ...
                    core.h("div", { class: 'time-picker' },
                        core.h("sm-time-picker", { onTimeSelected: (payload) => {
            ...
            core.h("div", { class: 'form-row' },
                core.h("label", { class: 'form-label' }, "End time"),
                core.h("div", { class: 'form-element date-time-picker' },
                    core.h("div", { class: 'date-picker' },
                        core.h("sm-date-picker", { onDateSelected: (payload) => {
                                component.selectedEvent.originalEndMoment = index.moment$1(payload.detail + ' ' + component.selectedEvent.originalEndMoment.format(INTERNAL_FORMAT.TIME));
...
class Calendar {
    ...
    render(component) {
        ...
        return (core.h("div", { class: 'sm-calendar-container', style: { '--header-height': '50px' } },
            core.h("header", { class: 'sm-calendar-header' }, header.render(component)),
            core.h("div", { class: 'sm-calendar-body' },
                component.viewRenderer.render(component),
                component.contextPanel.render(component)),
            core.h("div", { class: 'sm-calendar-other' }, editEvent.render(component))));
    }
}
...
class CalendarEvent {
    ...
    constructor(rawEvent, timezone = 'GMT') {
        ...
        if (INTERNAL_DATE_TIME_REGEX.test(this.start)) {
            this.startMoment = index.moment$1.tz(rawEvent.start, INTERNAL_FORMAT.DATE_TIME, true, timezone);
            this.originalStartMoment = this.startMoment.clone();
        }
        if (INTERNAL_DATE_TIME_REGEX.test(this.end)) {
            this.endMoment = index.moment$1.tz(rawEvent.end, INTERNAL_FORMAT.DATE_TIME, true, timezone);
...
const SmCalendar = class {
    constructor(hostRef) {
         ...
         * contextDate
         */
        this.contextDate = index.moment().format(INTERNAL_FORMAT.DATE);
        /**
         * availableViews
         */
         ...
         * state variables
         */
        this.contextMoment = index.moment(this.contextDate, INTERNAL_FORMAT.DATE, this.timezone);
        this.eventStore = eventStore;
        this.eventClick = core.createEvent(this, "eventClick", 7);
        this.cellClick = core.createEvent(this, "cellClick", 7);
        this.viewChange = core.createEvent(this, "viewChange", 7);
        this.eventUpdate = core.createEvent(this, "eventUpdate", 7);
    }
    /**
     * life cycle methods
     */
    ...
    render() {
        ...
        return (core.h(core.Host, { style: { '--theme-color': this.theme, '--component-height': componentHeight }, onClick: () => { } }, core.h("div", { class: 'sm-calendar' }, calendar.render(this))));
    }
    get ref() { return core.getElement(this); }
...
function getEvents() {
    const contextMoment = index.moment$1(CONTEXT_DATE, INTERNAL_DATE);
    return generateEvents(contextMoment);
}

const SmDemoCalendar = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.weekStartDay = 'sun';
    ...
    render() {
        return (core.h("div", { class: 'sm-demo-calendar' }, core.h("sm-calendar", { events: this.events, view: "month", "context-date": this.contextDate, onViewChange: (_payload) => {
...
exports.sm_calendar = SmCalendar;
exports.sm_demo_calendar = SmDemoCalendar;
