...
class DayView {
    ...
    renderViewContainer(component) {
        ...
        return (core.h("div", { class: 'day-view-container' },
    ...
    renderViewFooter(component) {
        return (core.h("div", null,
            ...
            core.h("button", { class: 'sm-button primary today-button', onClick: () => {
                    component.date = index.moment$1().format(INTERNAL_FORMAT.DATE);
                    component.showPicker = false;
                } }, "Today")));
    }
    renderViewNavigation(component) {
        ...
        return (core.h("div", { class: 'view-navigation' },
            ...
            core.h("div", { class: 'nav-item label' },
                core.h("span", { onClick: () => {
    ...
    renderViewContent(component, dates) {
        ...
        headerDates.forEach((date) => {
            headerDateCells.push(core.h("div", { class: 'day-name' }, date.format('ddd')));
        });
        const rows = [];
        ...
        return ([
            core.h("div", { class: 'view-header' }, headerDateCells),
            core.h("div", { class: 'view-content' }, rows),
            core.h("div", { class: 'view-footer' }, this.renderViewFooter(component))
        ]);
    }
    getRow(component, dates) {
        const cells = [];
        const selectedDate = index.moment$1(component.date);
        dates.forEach((date) => {
            const cls = ['date-cell'];
            if (index.moment$1().isSame(date, 'day')) {
                cls.push('today');
            }
            ...
            cells.push(core.h("div", { class: cls.join(' '), onClick: () => {
                    if (component.contextMoment.isSame(date, 'month')) {
        ...
        return (core.h("div", { class: "date-row" }, cells));
    }
}
...
class MonthView {
    ...
    renderViewContainer(component) {
        return (core.h("div", { class: 'month-view-container' },
            this.renderViewNavigation(component),
        ...
        return (core.h("div", { class: 'view-navigation' },
            core.h("div", { class: 'nav-item' },
                core.h("div", { class: "left-triangle", onClick: () => {
                        ...
                        navYear -= 1;
                        component.navMoment = index.moment().year(navYear).month(0).startOf('month');
                    } })),
            core.h("div", { class: 'nav-item label' },
                core.h("span", null, navMoment.format('YYYY'))),
            core.h("div", { class: 'nav-item' },
                core.h("div", { class: "right-triangle", onClick: () => {
                        let navYear = navMoment.year();
                        navYear += 1;
    ...
    renderViewContent(component) {
        ...
        index.moment.monthsShort().forEach((index$1) => {
            const monthStart = index.moment().year(navMoment.year()).month(index$1).startOf('month');
    ...
    getRow(component, dates) {
        ...
        dates.forEach((date) => {
            ...
            if (index.moment().isSame(date, 'month')) {
        ...
        return (core.h("div", { class: "month-row" }, cells));
    }
    renderViewFooter(component) {
        return (core.h("div", { class: 'view-footer' },
            core.h("button", { class: 'sm-button', onClick: () => {
                    component.pickerView = PICKER_VIEWS.DAY;
                } }, "Back"),
            core.h("button", { class: 'sm-button primary today-button', onClick: () => {
                    component.contextMoment = index.moment().startOf('month');
                    component.pickerView = PICKER_VIEWS.DAY;
                } }, "Current Month")));
    }
}
...
class DatePicker {
    ...
    renderPicker(component) {
        ...
        return (core.h("div", { class: 'sm-date-picker-popover' },
            core.h("div", { class: 'sm-date-picker-popover-container' }, currentView)));
    }
    render(component) {
...
const SmDatePicker = class {
    constructor(hostRef) {
         ...
         * date
         */
        this.date = index.moment$1().format(INTERNAL_FORMAT.DATE);
        /**
         * showPicker
         */
        ...
        this.contextMoment = index.moment$1(this.date, INTERNAL_FORMAT.DATE);
        this.navMoment = index.moment$1(this.date, INTERNAL_FORMAT.DATE);
        this.dateSelected = core.createEvent(this, "dateSelected", 7);
    }
    handleDateChange(date) {
        this.dateSelected.emit(date);
        this.contextMoment = index.moment$1(date, INTERNAL_FORMAT.DATE);
    }
    ...
    render() {
        return (core.h(core.Host, { style: { '--theme-color': this.theme } }, core.h("div", { class: 'sm-date-picker' }, core.h("div", { class: 'sm-date-picker-container' }, datePicker.render(this)))));
    }
...
exports.sm_date_picker = SmDatePicker;
