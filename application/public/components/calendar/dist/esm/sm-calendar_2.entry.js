...
class Column extends View {
    ...
    getSteps() {
        ...
        const today = moment$1().startOf('day');
        const stepMoments = [];
...
class Week extends Column {
    ...
    calculateViewRange(contextMoment, weekStartDay) {
        ...
        const endMoment = moment$1(startMoment).add(this.numberOfCols - 1, 'days').endOf('day');
        return { startMoment, endMoment };
    }
}
...
const SmCalendar = class {
    ...
    render() {
        ...
        return (h(Host, { style: { '--theme-color': this.theme, '--component-height': componentHeight }, onClick: () => { } }, h("div", { class: 'sm-calendar' }, calendar.render(this))));
    }
...
function getEvents() {
    const contextMoment = moment$1(CONTEXT_DATE, INTERNAL_DATE);
...
const SmDemoCalendar = class {
    ...
    render() {
        return (h("div", { class: 'sm-demo-calendar' }, h("sm-calendar", { events: this.events, view: "month", "context-date": this.contextDate, onViewChange: (_payload) => {
