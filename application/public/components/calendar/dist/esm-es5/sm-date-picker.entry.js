...
var DayView = /** @class */ (function () {
    ...
    DayView.prototype.render = function (component) {
        return this.renderViewContainer(component);
    };
    DayView.prototype.renderViewContainer = function (component) {
        var weekStartDay = component.weekStartDay, contextMoment = component.contextMoment;
        var dates = calculateDateRange(contextMoment, WEEK_DAYS[weekStartDay]);
        return (h("div", { class: 'day-view-container' }, this.renderViewNavigation(component), this.renderViewContent(component, dates)));
    };
    DayView.prototype.renderViewFooter = function (component) {
        return (h("div", null, h("button", { class: 'sm-button', onClick: function () {
                component.showPicker = false;
            } }, "Close"), h("button", { class: 'sm-button primary today-button', onClick: function () {
                component.date = moment().format(INTERNAL_FORMAT.DATE);
                component.showPicker = false;
            } }, "Today")));
    };
    DayView.prototype.renderViewNavigation = function (component) {
        var contextMoment = component.contextMoment;
        return (h("div", { class: 'view-navigation' }, h("div", { class: 'nav-item' }, h("div", { class: "left-triangle", onClick: function () {
                var currentDate = component.contextMoment.clone();
                currentDate.add(-1, 'months').date(1);
                component.contextMoment = currentDate;
            } })), h("div", { class: 'nav-item label' }, h("span", { onClick: function () {
                component.pickerView = PICKER_VIEWS.MONTH;
            } }, contextMoment.format('MMMM YYYY'))), h("div", { class: 'nav-item' }, h("div", { class: "right-triangle", onClick: function () {
                var currentDate = component.contextMoment.clone();
                currentDate.add(1, 'months').date(1);
                component.contextMoment = currentDate;
            } }))));
    };
    DayView.prototype.renderViewContent = function (component, dates) {
        var headerDates = dates.slice(0, 7);
        var headerDateCells = [];
        headerDates.forEach(function (date) {
            headerDateCells.push(h("div", { class: 'day-name' }, date.format('ddd')));
        });
        var rows = [];
        var rowCount = dates.length / 7;
    ...
    DayView.prototype.getRow = function (component, dates) {
        var cells = [];
        var selectedDate = moment(component.date);
...
var MonthView = /** @class */ (function () {
    ...
    MonthView.prototype.render = function (component) {
        return this.renderViewContainer(component);
    };
    MonthView.prototype.renderViewContainer = function (component) {
        return (h("div", { class: 'month-view-container' }, this.renderViewNavigation(component), this.renderViewContent(component)));
    };
    MonthView.prototype.renderViewNavigation = function (component) {
        var navMoment = component.navMoment;
        return (h("div", { class: 'view-navigation' }, h("div", { class: 'nav-item' }, h("div", { class: "left-triangle", onClick: function () {
                var navYear = navMoment.year();
                navYear -= 1;
                component.navMoment = moment$1().year(navYear).month(0).startOf('month');
            } })), h("div", { class: 'nav-item label' }, h("span", null, navMoment.format('YYYY'))), h("div", { class: 'nav-item' }, h("div", { class: "right-triangle", onClick: function () {
                var navYear = navMoment.year();
                navYear += 1;
                component.navMoment = moment$1().year(navYear).month(0).startOf('month');
            } }))));
    };
    MonthView.prototype.renderViewContent = function (component) {
        var navMoment = component.navMoment;
        var monthDateMoments = [];
        moment$1.monthsShort().forEach(function (index) {
            var monthStart = moment$1().year(navMoment.year()).month(index).startOf('month');
            monthDateMoments.push(monthStart);
        });
        var rows = [];
        var rowCount = monthDateMoments.length / 3;
        for (var i = 0; i < rowCount; i++) {
            rows.push(this.getRow(component, monthDateMoments.splice(0, 3)));
        }
        return __spreadArrays(rows, [this.renderViewFooter(component)]);
    };
    MonthView.prototype.getRow = function (component, dates) {
        var cells = [];
        dates.forEach(function (date) {
            var cls = ['month-cell'];
    ...
    MonthView.prototype.renderViewFooter = function (component) {
        return (h("div", { class: 'view-footer' }, h("button", { class: 'sm-button', onClick: function () {
                component.pickerView = PICKER_VIEWS.DAY;
            } }, "Back"), h("button", { class: 'sm-button primary today-button', onClick: function () {
...
var DatePicker = /** @class */ (function () {
    ...
    DatePicker.prototype.togglePicker = function (component) {
        component.showPicker = !component.showPicker;
    };
    DatePicker.prototype.renderDropdown = function (component) {
        var _this = this;
        // return (
    ...
    DatePicker.prototype.renderPicker = function (component) {
        ...
        return (h("div", { class: 'sm-date-picker-popover' }, h("div", { class: 'sm-date-picker-popover-container' }, currentView)));
    };
    DatePicker.prototype.render = function (component) {
        return ([this.renderDropdown(component), this.renderPicker(component)]);
    };
    return DatePicker;
}());
var datePicker = new DatePicker();
var SmDatePicker = /** @class */ (function () {
    function SmDatePicker(hostRef) {
    ...
    SmDatePicker.prototype.handleDateChange = function (date) {
        this.dateSelected.emit(date);
        this.contextMoment = moment(date, INTERNAL_FORMAT.DATE);
    };
    SmDatePicker.prototype.handleContextMomentChange = function (contextMoment) {
        this.navMoment = contextMoment.clone();
    };
    SmDatePicker.prototype.handleShowPickerChange = function () {
        this.pickerView = PICKER_VIEWS.DAY;
        this.contextMoment = moment(this.date, INTERNAL_FORMAT.DATE);
    };
    SmDatePicker.prototype.render = function () {
    ...
    Object.defineProperty(SmDatePicker, "watchers", {
        get: function () {
            return {
    ...
    Object.defineProperty(SmDatePicker, "style", {
